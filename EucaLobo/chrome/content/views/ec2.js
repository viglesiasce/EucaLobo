...
var ew_InstancesTreeView = {
    ...
    menuChanged  : function(event) {
        ...
        $("instances.context.startMonitoring").disabled =  instance.monitoringEnabled;
        $("instances.context.stopMonitoring").disabled = !instance.monitoringEnabled;
        $("instances.context.showMetrics").disabled = !instance.monitoringEnabled;
...
var ew_VolumeTreeView = {
    ...
    attachVolume : function ()
    {
        ...
        var instances = this.core.queryModel('instances', 'availabilityZone', image.availabilityZone, 'state', 'running');
        if (!instances.length) {
