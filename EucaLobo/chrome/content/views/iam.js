...
var ew_CredentialsTreeView = {
     ...
     editCredentials : function()
     {
         ...
         var values = this.core.promptInput('Credentials', [
                             ...
                             {label:"Access Key:",required:1,value:cred.accessKey,size:45},
                             {label:"Secret Access Key:",type:'password',required:1,value:cred.secretKey,size:45},
...
var ew_EndpointsTreeView = {
     ...
     addEndpoint: function(name, url) {
         var values = this.core.promptInput("Endpoint:", [ {label:"Name:", value:"ECC", type:'name', required:1},
                                                           {label:"Type",type:"menulist",list:["Eucalyptus","AWS"],required:1},
                                                           {label:"EC2 URL",type:'url', value: "http://eucalyptus.ecc.eucalyptus.com:8773", required:1},
                                                           {label:"S3 URL",type:'url', value:"http://walrus.ecc.eucalyptus.com:8773",required:1},]
